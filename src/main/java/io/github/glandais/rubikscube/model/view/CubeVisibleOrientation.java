...
public record CubeVisibleOrientation(SideEnum f, SideEnum r, SideEnum u, String notation) {
    ...
    public CubeVisibleOrientation(SideEnum f, SideEnum r, SideEnum u) {
        this(f, r, u, f.name().toLowerCase() + r.name().toLowerCase() + u.name().toLowerCase());
    }
}
